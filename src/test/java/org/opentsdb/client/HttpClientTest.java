...
public class HttpClientTest {
	...
	public void test_pushMetrics_DefaultRetries() {
		...
		builder.addMetric("metric1").setDataPoint(30L).addTag("tag1", "tab1value").addTag("tag2", "tab2value");
		builder.addMetric("metric2").setDataPoint(232.34).addTag("tag3", "tab3value");
